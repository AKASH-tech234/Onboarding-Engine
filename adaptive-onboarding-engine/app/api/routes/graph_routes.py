...
try:
    ...
    from api.controllers import graph_controller
    from schemas.graph_schema import GraphExpandRequest
except ImportError:  # pragma: no cover - alternate package root
    from app.api._compat import APIRouter, Body, HTTPException, Query
    from app.api.controllers import graph_controller
    from app.schemas.graph_schema import GraphExpandRequest

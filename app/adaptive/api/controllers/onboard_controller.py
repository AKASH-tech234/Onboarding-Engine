...
from app.adaptive.modules.pathway.response_builder import build_preview_response, build_response
from app.adaptive.schemas.job_schema import JobResponse, JobStatus
from app.adaptive.schemas.onboard_schema import OnboardPreviewResponse, OnboardRequest

try:
    from app.adaptive.queue import job_manager  # type: ignore
...
def _to_onboard_request(request: OnboardRequest | Mapping[str, Any]) -> OnboardRequest:
    ...
    try:
        from app.adaptive.schemas.onboard_schema import CandidateInput, JobInput, OptionsInput  # type: ignore
    except Exception:
        try:
            from app.adaptive.schemas.onboard_schema import CandidateInput, JobInput, OptionsInput  # type: ignore
        except Exception:

...
class TestWorkerIntegration(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.pathway_worker = importlib.import_module("workers.pathway_worker")
        cls.trace_worker = importlib.import_module("workers.trace_worker")
        cls.expansion_worker = importlib.import_module("workers.expansion_worker")

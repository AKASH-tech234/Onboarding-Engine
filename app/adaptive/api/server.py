...
from app.adaptive.api._compat import FASTAPI_AVAILABLE
from app.adaptive.api.app import create_app
from app.adaptive.config.settings import get_settings
from app.adaptive.utils.logger import configure_logging, get_logger
...
def run() -> None:
    ...
    uvicorn.run("app.adaptive.api.server:app", host=host, port=port, reload=reload_flag)

...
try:
    ...
    from graph import phase_assigner, pruning_engine, subgraph_extractor, topological_sort
    from graph.models import CandidateSkillLevel, LearningMode, Phase, PrunedItem
    from scoring import scoring_engine
except ImportError:  # pragma: no cover - alternate package root
    from app.modules.graph import graph_engine, phase_assigner, pruning_engine, subgraph_extractor, topological_sort
    from app.modules.graph.models import CandidateSkillLevel, LearningMode, Phase, PrunedItem
    from app.modules.scoring import scoring_engine

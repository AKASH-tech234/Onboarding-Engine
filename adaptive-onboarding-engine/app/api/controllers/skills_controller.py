...
try:
    ...
    from ingestion.skill_normalizer import normalize_skills as normalize_skill_names
except ImportError:  # pragma: no cover - alternate package root
    from app.modules.graph import graph_engine
    from app.modules.ingestion.skill_normalizer import normalize_skills as normalize_skill_names

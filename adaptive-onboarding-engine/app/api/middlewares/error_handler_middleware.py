...
try:
    from api._compat import FASTAPI_AVAILABLE, HTTPException, JSONResponse
except ImportError:  # pragma: no cover - alternate package root
    from app.api._compat import FASTAPI_AVAILABLE, HTTPException, JSONResponse
...
try:
    from utils.errors import GraphEngineError
except ImportError:  # pragma: no cover - alternate package root
    from app.utils.errors import GraphEngineError

...
try:
    from api._compat import APIRouter, FASTAPI_AVAILABLE, HTTPException, StreamingResponse
    from api.controllers import job_controller
except ImportError:  # pragma: no cover - alternate package root
    from app.api._compat import APIRouter, FASTAPI_AVAILABLE, HTTPException, StreamingResponse

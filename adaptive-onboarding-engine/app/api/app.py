...
try:
    from api._compat import FASTAPI_AVAILABLE, FastAPI
    ...
    from api.routes import graph_routes, health_routes, jobs_routes, onboard_routes, skills_routes
except ImportError:  # pragma: no cover - alternate package root
    from app.api._compat import FASTAPI_AVAILABLE, FastAPI
    ...
    from app.api.routes import graph_routes, health_routes, jobs_routes, onboard_routes, skills_routes

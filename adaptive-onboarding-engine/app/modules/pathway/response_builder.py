...
try:
    from pathway.pathway_builder import PathwayResult
except ImportError:  # pragma: no cover - alternate package root
    from app.modules.pathway.pathway_builder import PathwayResult
...
def build_response_model(pathway_result: PathwayResult | Mapping[str, Any]) -> Any:
    ...
    try:
        from schemas.pathway_schema import PathwayResponse  # type: ignore
    except Exception:
        return payload

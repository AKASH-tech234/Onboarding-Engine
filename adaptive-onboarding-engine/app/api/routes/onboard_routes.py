...
try:
    from api._compat import APIRouter, Body, HTTPException
    from api.controllers import onboard_controller
    from schemas.onboard_schema import OnboardRequest
except ImportError:  # pragma: no cover - alternate package root
    from app.api._compat import APIRouter, Body, HTTPException
    from app.api.controllers import onboard_controller
    from app.schemas.onboard_schema import OnboardRequest
